...
const Welcome = () => {
    return (
        <div className='p-16 border-red-400 overflow-hidden'>
            <h2 className='text-3xl sm:text-5xl md:text-7xl font-extrabold welcome-text text-center'>Welcome</h2>
            ...
            <div className=' border-red-500 flex justify-center items-center overflow-hidden'>
                <h2 className='text-white text-4xl sm:text-6xl md:text-8xl welcome-brand pb-5'>to Parsatopia</h2>
            </div>
        </div>
    );
};
